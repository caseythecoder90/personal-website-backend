...
public class CreateProjectRequest {
    ...
    @Schema(description = "URL-friendly slug (auto-generated if not provided)", example = "personal-website")
    private String slug;
    ...
    @Schema(description = "Project status (defaults to PLANNING if not provided)")
    ...
    @Valid
    @Schema(description = "Links to associate with this project (GitHub, demo, docs, etc.)")
    private List<CreateProjectLinkRequest> links;
}